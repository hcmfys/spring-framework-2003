...
public class CountriesPdfView extends AbstractPdfView {
    ...
    private static final Font TEXT_FONT = DATA_HEAD_FONT;//new Font(Font.nt, 8, Font.NORMAL, Color.black);
    private static final Font BOLD_FONT = DATA_HEAD_FONT;//new Font(Font.TIMES_NEW_ROMAN, 8, Font.BOLD, Color.black);
